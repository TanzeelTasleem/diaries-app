import { AppBar, Box, Button, createStyles, CssBaseline, Drawer, makeStyles, Theme, Toolbar, Typography } from '@material-ui/core'
...
export const DiaryList = () => {
    ...
    return (
        <Box>
            <DairyModal open={open} handleClose={handleClose} handleSubmit={handleSubmit} />
